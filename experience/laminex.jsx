...
function LaminexPanel({width, height, position, rotation, lighting}) {

  const {
      wall_material,
      wall_materials,
      setWallMaterial,} = useCustomisation(); 
      ...
      const generateWallMaterialProps = (materialList) => {
        const wallTextures = {};
        
        materialList.forEach((material) => {
          wallTextures[material] = useTexture({
            map: `/materials/walls/${material}.jpg`,
          });
      
          const wallTextureProps = wallTextures[material];
      ...
      const wallMaterialProps = generateWallMaterialProps(wallMaterials);
  ...
  return (
    <group position={position} rotation={rotation}>
      ...
      {wallMaterialProps[wall_material.texture] ? (
        <meshStandardMaterial {...wallMaterialProps[wall_material.texture]} />
      ) : (
