...
Command: npx gltfjsx@6.5.3 public\models\wall_sample_lowres.glb 
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/wall_sample_lowres.glb')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Cube003.geometry} material={nodes.Cube003.material} position={[10.332, 0, 0]} rotation={[Math.PI, 0, Math.PI]} />
...
useGLTF.preload('/wall_sample_lowres.glb')
